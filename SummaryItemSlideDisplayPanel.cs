...
namespace IATClient
{
    class SummaryItemSlideDisplayPanel : Panel
    {
        ...
        public SummaryItemSlideDisplayPanel(int blockNum, IATConfigFileNamespace.ConfigFile cf, CItemSlideContainer slideContainer, int width, Padding slidePadding)
        {
