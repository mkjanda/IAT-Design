  ...
  <xsl:variable name="Functions">
    ...
    <xsl:element name="Function">
      ...
      <xsl:element name="FunctionBody">
        ...
        <xsl:element name="Code">while (ctr &lt; validateFunctions.length) {</xsl:element>
        ...
        <xsl:element name="Code">questionElems[ctr].style.visibility = "hidden";</xsl:element>
        <xsl:element name="Code">questionElems[ctr].style.maxHeight = "1px";</xsl:element>
        <xsl:element name="Code">questionElems[ctr].style.height = "1px";</xsl:element>
        <xsl:element name="Code">validateFunctions.splice(ctr, 1);</xsl:element>
        <xsl:element name="Code">questionElems.splice(ctr--, 1);</xsl:element>
    ...
    <Declarations>
      ...
      <xsl:variable name="questionNdxs">
        <xsl:for-each select="//Response">
          <xsl:if test="@Type ne 'Instruction'">
            <xsl:element name="elem">
              <xsl:value-of select="concat('document.getElementById(&quot;ItemLITag', position() - 1, '&quot;)')" />
            </xsl:element>
          </xsl:if>
        </xsl:for-each>
      </xsl:variable>
      <Declaration>
        <xsl:value-of select="concat('var questionElems = [', string-join(for $e in $questionNdxs/elem return $e, ', '), '];')" />
      </Declaration>
    </Declarations>
  </xsl:variable>
    ...
    <xsl:element name="Function">
      ...
      <xsl:element name="FunctionBody">
        ...
        <xsl:if test="$optional eq 'True'">
          ...
          <xsl:element name="Code">answerInputs[0].value = "Unanswered";</xsl:element>
    ...
    <xsl:element name="Function">
      ...
      <xsl:element name="FunctionBody">
        ...
        <xsl:if test="$optional eq 'True'">
          ...
          <xsl:element name="Code">responseElement.value = "Unanswered";</xsl:element>
          <xsl:element name="Code">return -1;</xsl:element>
          <xsl:element name="Code">}</xsl:element>
        </xsl:if>
        <xsl:element name="Code">
