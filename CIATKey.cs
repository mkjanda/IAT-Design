...
namespace IATClient
{
    ...
    public class CIATKey : IPackagePart, IDisposable
    {
        ...
        {
            foreach (CIATKey k in KeyOwners.Cast<CIATKey>())
                k.InvalidateValues();
        }
        ...
        public virtual Size GetDISize(Uri diUri) 
        {
            return CIAT.SaveFile.Layout.KeyValueSize;
        }
        ...
        public virtual Uri LeftValueUri
        {
            ...
            set
            {
                ...
                if (_LeftValueUri != null)
                    (CIAT.SaveFile.GetDI(_LeftValueUri) as IResponseKeyDI).ReleaseKeyOwner(this);
                _LeftValueUri = value;
        ...
        public virtual Uri RightValueUri
        {
            ...
            set
            {
                ...
                if (_RightValueUri != null)
                    (CIAT.SaveFile.GetDI(_RightValueUri) as IResponseKeyDI).ReleaseKeyOwner(this);
        ...
        public virtual void Dispose()
        {
            if (IsDisposed)
                return;
            IsDisposed = true;
            IResponseKeyDI leftVal = null, rightVal = null;
            if (LeftValueUri != null)
