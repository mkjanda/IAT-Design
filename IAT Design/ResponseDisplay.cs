    ...
    abstract partial class ResponseDisplay : UserControl
    {
        ...
        protected Font DisplayFont
        {
            get
            {
                if (_DisplayFont == null)
                    _DisplayFont = new Font(Format.FontFamily, LogicalToDeviceUnits(Format.FontSizeAsPixels), Format.FontStyle, GraphicsUnit.Point);
                return _DisplayFont;
            }
            set
            {
        ...
        */
        public SurveyItemFormat Format
        {
            ...
            {
                _Format = value;
                DisplayFont = new Font(value.Font.FontFamily, value.Font.GetHeight(72F));
            }
        }
