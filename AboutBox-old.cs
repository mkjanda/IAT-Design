...
namespace IATClient
{
    partial class AboutBoxOld : Form
    {
        ...
        {
            InitializeComponent();
            this.ProductKeyLabel.Text = String.Format("Product Key: {0}", CActivation.ProductKey);
            ProgressTimer.Interval = 50;
            ProgressTimer.Tick += new EventHandler(ProgressTimer_Tick);
            ProgressImageBox.Size = new Size(ProgressImageBox.Height, ProgressImageBox.Height);
            ...
            DownloadLabel.Size = new Size(ProgressPanel.Width - ProgressImageBox.Right, ProgressPanel.Height);
            ...
            this.ProductDescription.Text = AssemblyDescription;
