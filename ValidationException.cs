...
namespace IATClient
{
    ...
    public class CIATBlockLocationDescriptor : CLocationDescriptor
    {
        ...
        public CIATBlockLocationDescriptor(CIATBlock block, CIATItem item)
        {
            Block = block;
            Item = item;
        }
    ...
    class CIATInstructionScreenLocationDescriptor : CLocationDescriptor
    {
        ...
        public CIATInstructionScreenLocationDescriptor(CInstructionBlock instructionBlock, CInstructionScreen instructionScreen)
        {
