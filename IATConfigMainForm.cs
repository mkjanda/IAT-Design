        ...
        public EFormContents FormContents
        {
           get
            ...
            set
            {
                ...
                {
                    IATConfigMainForm.ShowErrorReport("User interface error", new CReportableException("Error changing interface", ex));
                }
            }
        }
        ...
        */
        ...
        private void IATConfigMainForm_Shown(object sender, EventArgs e)
        {
            ...
            else if (MessageBox.Show(Properties.Resources.sRecoveryFileDetected, Properties.Resources.sRecoveryFileDetectedCaption, MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                {
                    ShowErrorReport("Error loading recovery file", new CReportableException(ex.Message, ex));
        ...
        private void ShowSurveyPanel(SurveyPanel.EOrdinality Ordinality, IContentsItem SurveyItem)
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Display, SurveyItem.URI);
        }
        ...
        private void ShowIATBlockPanel(IContentsItem Block)
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Display, Block.URI);
        }
        ...
        public void SetActiveIATItem(CIATItem item)
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Display, item.URI);
        }
        ...
        private void ShowInstructionsPanel(IContentsItem InstructionBlock)
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Display, InstructionBlock.URI);
        }
        ...
        public void SetActiveInstructionScreen(CInstructionScreen screen)
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Display, screen.URI);
        }
        ...
        private void ShowLayoutPanel()
        {
            ...
            CIAT.ActivityLog.LogEvent(ActivityLog.EventType.Open, CIAT.SaveFile.Layout.URI);
        }
/*
        ...
        */
        ...
        public void Open()
        {
            ...
            {
                IATConfigMainForm.ShowErrorReport("Error disposing of test", new CReportableException("Error disposing of test", ex));
            }
            try {
                Modified = false;
                CurrentFilename = dialog.FileName;
            ...
            {
                IATConfigMainForm.ShowErrorReport("Error loading save file", new CReportableException("Error loading save file", ex));
            }
            //      ConstructViewMenu(true);
            if (m_MainPanel == null)
            {
        ...
        private static bool Halting { get; set; } = false;
        ...
        */
        ...
        public static void ShowErrorReport(String caption, CReportableException ex)
        {
            if (Halting)
                return;
            Task.Run(() =>
            {
                ...
                ErrorReportThread = new Thread(new ThreadStart(() =>
                {
                    ...
                    try
                    {
                        ...
                        Task<String> reportError = Task<String>.Run(() =>
                        {
                            try
                            {
                                return Encoding.UTF8.GetString(uploader.UploadData(Properties.Resources.sErrorReportURL, clientEx.GetXmlBytes()));
                            }
                        ...
                        reportError.Wait(10000);
                        spl.Close();
                        if (!reportError.IsCompleted || (reportError.Result != "success"))
                        {
                            ErrorsReported--;
                            ErrorReportDisplay f = new ErrorReportDisplay(ex);
                            f.ShowDialog();
        ...
        private void UploadButton_Click(object sender, EventArgs e)
        {
            ...
            Task.Run(() =>
            {
                ...
                {
                    ShowErrorReport("Error uploading IAT", new CReportableException(ex.Message, ex));
                }
            });
