    ...
    public class CUniqueResponse : IPackagePart
    {
        ...
        public void Load()
        {
            try
            {
                ...
                String rSurveyId = xDoc.Root.Attribute("rSurveyId").Value;
                ...
                {
                    String rSurveyItemId = xDoc.Root.Attribute("rSurveyItemId").Value;
                    if (rSurveyItemId != String.Empty)
                        _SurveyItemUri = CIAT.SaveFile.GetRelationship(this, rSurveyItemId).TargetUri;
                }
