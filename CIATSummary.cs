...
namespace IATClient
{
    public class CIATSummary
    {
        ...
        private IATConfigFileNamespace.ConfigFile.ERandomizationType RandomizationType;
        ...
        public CIATSummary(IATConfigFileNamespace.ConfigFile cf)
        {
            ...
            {
                if (cf.EventList[ctr].EventType == IATConfigFileNamespace.IATEvent.EEventType.BeginIATBlock)
                {
                    NumPresentations.Add(((IATConfigFileNamespace.BeginIATBlock)cf.EventList[ctr]).NumPresentations);
                    NumStimuli.Add(((IATConfigFileNamespace.BeginIATBlock)cf.EventList[ctr]).NumItems);
                }
                ctr++;
            }
