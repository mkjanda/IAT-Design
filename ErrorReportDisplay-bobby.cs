...
namespace IATClient
{
    ...
    {
        private CDeploymentException TheException;
        private Label ErrorLabel = new Label();
        private Label ErrorText = new Label();
        private TextBox InstructionsTextBox = new TextBox();
        ...
        public ErrorReportDisplay(CDeploymentException ex)
        {
            ...
            InstructionsTextBox.Text = "Please click the Copy to Clipboard button below and paste the following in an email addressed to admin@iatsoftware.net";
        ...
        void HistFace_Paint(object sender, PaintEventArgs e)
        {
            ...
            TheException.Draw(e.Graphics, SystemFonts.DialogFont, 5, 5);
        }
