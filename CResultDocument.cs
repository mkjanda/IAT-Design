...
namespace IATClient
{
    ...
    class CResultDocument
    {
        ...
        public void SetResultData(CResultData resultData, CItemSlideContainer container)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                IATConfigMainForm.ShowErrorReport("Error parsing result data", rex);
            }
        }
        ...
        private void WriteToFile(String filename, BackgroundWorker worker)
        {
            ...
            catch (Exception ex)
            {
                ...
                IATConfigMainForm.ShowErrorReport("Error exporting to Excel", reportable);
            }
        }
    }
}
