...
namespace IATClient
{
    public class LayoutItem : Enumeration
    {
        ...
        public readonly static LayoutItem[] All = new LayoutItem[] { Lambda, Stimulus, LeftResponseKey, RightResponseKey, BlockInstructions, ErrorMark, ContinueInstructions, 
    ...
    public class CIATLayout : IStoredInXml, IPackagePart, IDisposable
    {
        ...
        private static ObservableUri ErrorMarkObservableUri
        {
            get
            {
        ...
        private static ObservableUri LeftKeyValueOutlineObservableUri
        {
            get
            {
        ...
        private static ObservableUri RightKeyValueOutlineObservableUri
        {
            get
            {
        ...
        {
            if (ErrorMarkUri == null)
                ErrorMarkUri = new DIErrorMark().URI;
            if (LeftKeyValueOutlineUri == null)
                LeftKeyValueOutlineUri = new DIKeyValueOutline(KeyedDirection.Left).URI;
            if (RightKeyValueOutlineUri == null)
                RightKeyValueOutlineUri = new DIKeyValueOutline(KeyedDirection.Right).URI;
            ...
            CIAT.SaveFile.GetDI(ErrorMarkUri);
            CIAT.SaveFile.GetDI(LeftKeyValueOutlineUri);
            CIAT.SaveFile.GetDI(RightKeyValueOutlineUri);
        }
        ...
        public void Load(Uri uri)
        {
            ...
            RightKeyValueOutlineObservableUri = CIAT.SaveFile.GetObservableUri(new Uri(xDoc.Root.Attribute("RightKeyValueOutlineObservable").Value, UriKind.Relative));
