...
namespace IATClient
{
    class LocalStorage
    {
        ...
        public enum EActivationStatus { NotActivated, EMailNotVerified, Activated };
    ...
    class ActivationObject
    {
        ...
        public void Activate(String fName, String lName, String eMail, String title, String productKey)
        {
            ...
            ActivationWebSocket.CloseAsync(WebSocketCloseStatus.NormalClosure, "Activation Attempt Complete", AbortToken);
        }
