...
namespace IATClient
{
    ...
    class CEnvelope : INamedXmlSerializable
    {
        ...
        public static CEnvelope BuildEnvelope(String msg)
        {
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            try
            {
                ...
                else if (MessageType == EMessageType.ServerException)
                {
                    IATConfigMainForm.ShowErrorReport("Server Error", _Message as CServerException);
                }
            }
            catch (CUnexpectedServerMessage ex)
            {
                IATConfigMainForm.ShowErrorReport("Unexpected message from server", ex.ReportableException);
            }
        }
